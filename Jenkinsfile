pipeline {
    ...
    environment {
        ...
        IMAGE_NAME     = "fintech-python-app-manisha" // Add your name here
        CONTAINER_NAME = "fintech-prod-container-manisha" // Add your name here
        
        // ZAP Configuration
        ZAP_PORT       = "9003" // Change the port
        
        // Map Cosign Credentials
        COSIGN_PASSWORD = credentials('cosign-private-key')
        SONAR_SERVER_NAME = "sonar-server-admin"
        SONAR_PROJECT_KEY = "fintech-app-manisha" // Add your name here
    }
